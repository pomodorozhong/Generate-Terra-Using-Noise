...
function drawFrame() {
    let start = Date.now();
    if (seeded === false) {
        perlin_1.noiseModule.seed(Math.random());
        seeded = true;
    }
    // Cache width and height values for the canvas.
    let cWidth = canvas.width;
    let cHeight = canvas.height;
    let noisefn = fn === 'simplex' ? perlin_1.noiseModule.simplex3 : perlin_1.noiseModule.perlin3;
...
function noiseToColor(noiseValue, cellCount) {
    if (noiseValue > 240) {
        // Orange
...
function drawRenderedTimeCost(start, end, cWidth, cHeight) {
...
},{"./perlin":2}],2:[function(require,module,exports){
"use strict";
/*
...
exports.noiseModule.seed = function (seed) {
    if (seed > 0 && seed < 1) {
        // Scale the seed out
        seed *= 65536;
    }
...
exports.noiseModule.simplex2 = function (xin, yin) {
...
exports.noiseModule.simplex3 = function (xin, yin, zin) {
...
exports.noiseModule.perlin2 = function (x, y) {
...
exports.noiseModule.perlin3 = function (x, y, z) {
    // Find unit grid cell containing point
